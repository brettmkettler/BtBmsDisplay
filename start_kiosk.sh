...
chromium-browser --kiosk --no-sandbox --disable-web-security --disable-features=VizDisplayCompositor --user-data-dir="$CHROME_DATA_DIR" --enable-touch-events --force-device-scale-factor=2.1 --disable-dev-shm-usage --disable-gpu --no-first-run --disable-default-apps --disable-infobars --disable-session-crashed-bubble --disable-translate http://localhost:3000